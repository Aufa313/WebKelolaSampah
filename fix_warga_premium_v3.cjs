...
console.log("Running refactor_warga.cjs...");
execSync('node refactor_warga.cjs');

console.log("Injecting premium features at component start...");
...
// 2. Inject states and variables at component start
const componentStartStr = 'export default function DashboardWarga({ onBack }: DashboardWargaProps) {';
...
content = content.replace(componentStartStr, componentStartStr + premiumSetup);

// 3. Define userLevelInfo after mutations state is declared
...
console.log("DashboardWarga premium features v3 refactored successfully!");
